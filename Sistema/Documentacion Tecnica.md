Objetivo hacer un mvp de un sistema de gestion de proyectos :
GED + BPM + Expedientes
...
- Consultar los expedientes de la propia oficina.
- Gestionar usuarios y sus accesos.
- Inspección de proyectos y expedientes para los administradores del sistema
- Búsqueda por contenido de expedientes
- Estados de los Expedientes
- Notificaciones por Expediente faltantes.
...
Subdomains:  
- Document Management (core subdomain)
- Identity wrapper keycloak (support subdomain)
- Keycloak IAM (generic subdomain)
- Storage SeaweedFS (generic subdomain)
- Workflow Inngest (support subdomain)
...
* Gestión de expedientes y proyectos (nivel logica)
* Versionado 
* Estados expedientes
...
* Gestión de flujos de expediente
* Orquestación de procesos
* Gestión de estados
* Aprobaciones expedientes
* Derivaciones
...
### Grupo 1: 
roles: Jefe de Oficina , Técnico/administrativo
...
### Grupo 2
roles: Jefe de Oficina ,Residente , Técnico/administrativo
...
### Grupo 3: 
roles: Jefe de Oficina , Inspector
...
El roltiene acceso administrativo de consulta y registro.
...
El Jefe de Oficina es responsable operativo de los expedientes de su oficina.
...
| ------------------------------------- | ---------------------------------------------------------------- |
| Ver expediente propios                | Todos los roles                                                  |
| Ver expedientes de todas las oficinas | Super Usuario, Administrador                                     |
| Ver expediente de la propia oficina   | Jefe de Oficina y roles operativos                               |
| Subir documentos PDF                  | Super Usuario, Administrador, Jefe de Oficina y roles operativos |
| Cambiar estado de expediente          | Super Usuario, Jefe de Oficina                                   |
| Registrar justificación               | Super Usuario, Jefe de Oficina                                   |
| Alertar expediente faltantes          | Super Usuario, Jefe de Oficina y roles operativos                |
...
| Técnico/Admin   | Carga documental y gestión operativa                                  |
...
| Rol                    |     | Función                  |
| ---------------------- | --- | ------------------------ |
| Jefe de Oficina        |     | Supervisión y aprobación |
| Residente              |     | Gestión documental       |
| Técnico/Administrativo |     | Registro administrativo  |
...
| --------------- | --- | ------------------------ |
| Jefe de Oficina |     | Supervisión y aprobación |
| Inspector       |     | Inspección y reportes    |
...
| RF-10 | Carga de Expedientes       | Al subir un documento se presentará un formulario y el sistema generará automáticamente la metadata.                              | Alta      |
| RF-11 | Carga de Expediente        | El sistema generará automáticamente un nombre único para cada documento subido mediante hash-checksum.                            | Baja      |
| RF-12 | Carga de Expediente        | No se exigirá un orden de carga en el MVP; los usuarios podrán subir documentos en cualquier momento.                             | Alta      |
| RF-13 | Carga de Documento         | El sistema rechazará formatos distintos a PDF y DOCX como JPG, PNG u otros.                                                       | Baja      |
...
* Gestion de proyectos, cada una con sus respecitvos expedientes
